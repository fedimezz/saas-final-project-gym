  ...
  return (
    <div className={`min-h-screen transition-all duration-300 ${isDarkMode ? "bg-neutral-950" : "bg-gradient-to-b from-gray-50 to-white"}`}>
      ...
      <section className="relative h-[50vh] overflow-hidden">
        <img src={img("heroImage", "https://images.unsplash.com/photo-1549719386-74dfcbf7dbed?w=1200&h=600&fit=crop")} alt="Fight Club" className="w-full h-full object-cover" />
