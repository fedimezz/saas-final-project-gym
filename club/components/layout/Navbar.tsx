...
export function Navbar() {
  ...
  const { name: clubName, logoUrl, isPageEnabled } = useClubSettings();
  const { t } = useLanguage();
            ...
            <Link href="/" className="flex items-center space-x-3 group">
              <div className="relative flex items-center justify-center">
                ...
                {logoUrl ? (
                  ...
                  <img src={logoUrl} alt={clubName} className="relative h-9 w-9 rounded-xl object-cover shadow-md flex-shrink-0" />
                ) : (
                  ...
                  {isAdmin ? (
                    <div className="relative dashboard-menu-dropdown">
                      ...
                      >
                        {userAvatar ? (
                          // eslint-disable-next-line @next/next/no-img-element
                          <img src={userAvatar} alt={user?.name || "Admin"} className="h-7 w-7 rounded-full object-cover border border-emerald-400/50 flex-shrink-0" />
                        ) : (
                    ...
                    <Link href="/dashboard">
                      ...
                      >
                        {userAvatar ? (
                          // eslint-disable-next-line @next/next/no-img-element
                          <img src={userAvatar} alt={user?.name || "User"} className="h-7 w-7 rounded-full object-cover border border-emerald-400/50 flex-shrink-0" />
                        ) : (
                          <div className="h-7 w-7 rounded-full bg-emerald-500 text-slate-950 flex items-center justify-center font-extrabold text-xs flex-shrink-0 shadow-sm">
